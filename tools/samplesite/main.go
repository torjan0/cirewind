...
func runReadme(ctx context.Context, args []string, stdout, stderr io.Writer) int {
	...
	var caseDir, outDir, version, assetsDir string
	...
	flags.StringVar(&assetsDir, "assets-dir", "site/assets", "directory holding the fixed README banner asset")
	...
	candidate, err := samplesite.BuildReadmeCandidate(ctx, caseDir, samplesite.ReadmeSlots{Version: version, Final: final, AssetsDir: assetsDir})
	if err != nil {
