...
## Automated/human/external responsibility matrix
...
| Activity | Automated implementation session | Maksim | Additional project maintainer(s) (unassigned) | Outside human |
|---|---|---|---|---|
